...
# TODO: Make sure mentions of 'AudioCLIP' changed to 'CANARI'
class CANARI(CLIP):
    ...
    def __init__(self,
        ...
        # MODIFICIATION
        self.a = torch.nn.Parameter(torch.ones([1, 1024]))
        self.b = torch.nn.Parameter(torch.ones([1, 1024]))
        self.image_sigmoid = torch.nn.Sigmoid()
